package com.spring.vardhan.employeeservice;
...
import com.spring.vardhan.employeeservice.model.Employee;
import com.spring.vardhan.employeeservice.repository.EmployeeRepository;
...
public class EmployeeServiceApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.spring.vardhan.employeeservice.controller"))
