package com.spring.vardhan.departmentservice;
...
import com.spring.vardhan.departmentservice.model.Department;
import com.spring.vardhan.departmentservice.repository.DepartmentRepository;
...
public class DepartmentServiceApplication {
	...
	public Docket swaggerPersonApi10() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.spring.vardhan.departmentservice.controller"))
